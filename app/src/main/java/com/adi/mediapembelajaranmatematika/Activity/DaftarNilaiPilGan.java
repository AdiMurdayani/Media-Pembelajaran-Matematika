...
public class DaftarNilaiPilGan extends AppCompatActivity {
    ...
    private void init() {
        ...
        btn_kembali.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                DaftarNilaiPilGan.super.onBackPressed();
            }
        });
        ...
        refreshLayout = findViewById(R.id.sw_layout_pilgan);
        ...
        reference.child("kuis_pilgan").child(auth.getUid()).child("daftar_nilai")
                .addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        ...
                        adapter = new AdapterKuisPilgan(listnilai, DaftarNilaiPilGan.this);
                    ...
                    public void onCancelled(@NonNull DatabaseError error) {
                        Toast.makeText(DaftarNilaiPilGan.this, "Data Gagal Dimuat", Toast.LENGTH_LONG).show();
